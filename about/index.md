...
<div class="container my-5">
    <div class="row">
        <div class="col">
            ...
            <br>
				<div style="text-align: center;"><h3>Our TexLUG-SA <a href="Group_TexLUG-SA_By-Laws.md">By-Laws</a> and <a href="/assets/pdfs/Group_TexLUG-SA_Code_of_Conduct_Rev1.pdf">Code of Conduct</a></h3></div>
			</p>
        </div>
    </div>
    <div class="row my-4">
